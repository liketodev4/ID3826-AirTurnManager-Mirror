...
namespace AirTurnManager.Api.Foundation
{
    ...
    public class ATBase
    {
        ...
        public bool _ownsMemory = true;
        /// true if init has completed
        public bool _hasInitCompleted = true;
        /// The type of the object
        public ATObjectType _type;
        ...
        public static extern ATBase ATBaseNew(ATBase optionalStorage);
        ...
        [DllImport(Constants.ATSC_API)]
        public static extern ATBase ATBaseInit(ATBase baseObj);
        ...
        [DllImport(Constants.ATSC_API)]
        public static extern bool ATBaseCopy(ATBase destination, ATBase source);
    }
}
